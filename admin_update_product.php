...
if(isset($_POST['update_product'])){
   ...
   $update_product = $conn->prepare("UPDATE `products` SET name = ?, cost = ?, details = ?, price = ? WHERE id = ?");
   $update_product->execute([$name, $cost, $details, $price, $pid]);
...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" name="cost" min="0" placeholder="enter product cost" required class="box" value="<?= $fetch_products['cost']; ?>">
